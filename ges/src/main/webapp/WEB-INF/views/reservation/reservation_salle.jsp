        ...
        <div class="content-wrapper backwhite">
            <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/reservation">
                <div style="display:inline-block;margin-bottom:50px;">
                    ...
                    <a class="btn btn-primary btn-lg" style="font-size:25px;text-align:center;border-color:rgb(181, 57, 103);background-color:rgb(181, 57, 103);margin-top: 30px;" href="${pageContext.request.contextPath}/reservation_create_equipement">+</a> 
                </div>
            </form>

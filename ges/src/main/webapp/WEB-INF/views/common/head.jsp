<%@ page contentType="text/html;charset=UTF-8" %>
    ...
    <head>
        ...
        <title>Equipements et salles MIN-EPF</title>
        <link rel="icon" type="image/png" href="resources/stockage/logoEPFc.png" />
    ...
    <![endif]-->
        ...
        <!-- Google Font -->
        <link rel="stylesheet"
            href="hsttps://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
    </head>